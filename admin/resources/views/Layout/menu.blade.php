            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <li> <a href="{{url('/project')}}" ><span> <i class="fas fa-tv"></i> </span><span class="hide-menu">Projects</span></a></li>
                       <li> <a href="{{url('/contacts')}}" ><span> <i class="fas fa-id-card"></i> </span><span class="hide-menu">Contacts</span></a></li>
                       <li> <a href="{{url('/review')}}" ><span> <i class="fas fa-id-card"></i> </span><span class="hide-menu">Review</span></a></li>
                       <li> <a href="{{url('/photo')}}" ><span> <i class="fas fa-id-card"></i> </span><span class="hide-menu">Photo Gallery</span></a></li>
